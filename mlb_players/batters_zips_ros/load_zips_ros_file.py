...
inFile = open("/home/creich/Desktop/encompass/mlb_players/player_artifacts/zips_batters_download_cleaned.csv", "r")
...
cur.execute("truncate table mlb_players.zips_ros_load")
...
for line in inFile:
    try:
        ...
        s1 = "insert into mlb_players.zips_ros_load values ( "
...
print("ZIPS Batter data loaded into database")
