...
inFile = open("/home/creich/Desktop/encompass/mlb_players/player_artifacts/fangraphs_advanced_pitching_download_cleaned.csv", "r")
...
cur.execute("truncate table mlb_players.fangraphs_pitching_advanced_load")
...
for line in inFile:
    try:
        ...
        s1 = "insert into mlb_players.fangraphs_pitching_advanced_load values ( "
...
print("Fangraphs Advanced Pitcher data loaded into DB")
