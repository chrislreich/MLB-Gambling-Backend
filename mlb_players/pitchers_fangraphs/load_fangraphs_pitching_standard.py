...
inFile = open("/home/creich/Desktop/encompass/mlb_players/player_artifacts/fangraphs_standard_pitching_download_cleaned.csv", "r")
...
cur.execute("truncate table mlb_players.fangraphs_pitching_standard_load")
...
for line in inFile:
    try:
        ...
        s1 = "insert into mlb_players.fangraphs_pitching_standard_load values ( "
...
print("Fangraphs Standard Pitcher data loaded into DB")
