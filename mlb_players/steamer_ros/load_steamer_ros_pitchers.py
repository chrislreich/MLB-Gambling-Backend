...
inFile = open("/home/creich/Desktop/encompass/mlb_players/player_artifacts/steamer_pitchers_download_cleaned.csv", "r")
...
cur.execute("truncate table mlb_players.steamer_ros_pitchers_load")
...
for line in inFile:
    ...
    s1 = "insert into mlb_players.steamer_ros_pitchers_load values ( "
